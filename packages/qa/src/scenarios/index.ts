...
import {dryRunLifecycleScenario} from "./dry-run-lifecycle.js";
import {dryRunMultiTxScenario} from "./dry-run-multi-tx.js";
...
export const ALL_SCENARIOS: Scenario[] = [
  ...
  dryRunLifecycleScenario,
  dryRunMultiTxScenario,
];
